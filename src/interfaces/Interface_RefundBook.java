...
public class Interface_RefundBook extends javax.swing.JFrame {
    ...
    Date dateDelivery;
    String deliString, auxT, auxC; 
    
    private TextAutoCompleter autoCompleter;    
    
    public Interface_RefundBook () {
        initComponents();
    ...
    private void initComponents() {
        ...
        lb_titleMain.setText("Refund of Books");
        ...
        getContentPane().add(lb_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, -1, -1));
        ...
        getContentPane().add(txf_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 310, -1));

        lb_message.setFont(new java.awt.Font("Arial Narrow", 3, 18)); // NOI18N
        lb_message.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(lb_message, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 340, -1, -1));
        ...
        getContentPane().add(dtC_delivery, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 190, -1));
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        try {
            ...
            if (studentFile.searchStudent(id) == true) {
                ...
                if (new_BookFile.availabilityISfalse(auxC, auxT) == true) {
...
//                    } 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interface_RefundBook().setVisible(true);
            }
        });
    }
